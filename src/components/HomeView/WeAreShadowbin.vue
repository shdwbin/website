      ...
      const people: Person[] = [
        {
          name: "Hanna",
          position: "Founder",
          image: await rest.get(Routes.user("333459879379337216"))["avatar_url"],
        ...
        },
        {
          ...
          image: await rest.get(Routes.user("242351388137488384"))["avatar_url"],
        ...
        },
        {
          ...
          image: await rest.get(Routes.user("279692618391093248"))["avatar_url"],
          bio: "Lorem ipsum, lorem ipsum.",
